...
function LegalPage({ document, contactInfo }) {
  ...
  return (
    <div className="orion-page-bg min-h-screen text-[#222222]">
      ...
      <main className="section-shell pb-12 pt-4 sm:pb-16 sm:pt-8">
        <article className="soft-card-strong mx-auto max-w-4xl overflow-hidden">
          <div className="border-b border-[#FFE0CC] bg-[#FFF8F0] p-5 sm:p-8">
            ...
            <p className="mt-4 max-w-2xl text-base font-semibold leading-7 text-[#222222]/68">
              {document.description}
            </p>
            <p className="mt-4 text-sm font-bold text-[#222222]/46">Son güncelleme: 8 Haziran 2026</p>
          </div>

          <div className="grid gap-5 p-5 sm:p-8">
            {document.sections.map((section) => (
              <section key={section.heading} className="rounded-2xl border border-[#FFE0CC] bg-white p-4 sm:p-5">
                <h2 className="text-lg font-black text-[#222222]">{section.heading}</h2>
                <div className="mt-3 grid gap-3 text-sm font-semibold leading-7 text-[#222222]/66 sm:text-base">
