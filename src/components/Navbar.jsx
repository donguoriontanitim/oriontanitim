...
const navItems = [
  { label: 'Ana Sayfa', sectionId: 'hero', icon: Home },
  { label: 'Program', sectionId: 'program', icon: BookOpen },
  { label: 'Neden Orion?', sectionId: 'neden-orion', icon: Sparkles },
  { label: 'Günlük Akış', sectionId: 'akis', icon: CalendarClock },
  { label: 'Galeri', sectionId: 'galeri', icon: Images },
  { label: 'SSS', sectionId: 'sss', icon: CircleHelp },
  { label: 'İletişim', sectionId: 'iletisim', icon: MessageCircle },
]
        ...
        <div className="flex min-h-16 items-center justify-between gap-2 px-3 py-2.5 sm:min-h-18 sm:gap-3 sm:px-4 sm:py-3 lg:px-5">
          ...
          <div className="hidden items-center justify-center gap-1 xl:flex">
            {navItems.map((item) => (
              <a
                key={item.sectionId}
                href={getLandingSectionHref(item.sectionId)}
          ...
          <div className="flex items-center gap-2">
            ...
            >
              ...
              <span className="hidden sm:inline">Kayıt Bilgisi Al</span>
